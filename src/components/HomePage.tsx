          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Streamlining code reviews for modern development teams.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Features</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Pricing</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Documentation</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">API</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">About</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Blog</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Careers</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Contact</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Twitter</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">GitHub</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">Discord</a>
                <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors block text-sm">LinkedIn</a>
              </div>
            </div>
          </div>
