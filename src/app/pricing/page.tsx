...
const pricingTiers = [
  {
    ...
    features: [
      ...
      'Code analysis and fixes through dashboard',
  ...
  },
  {
    ...
    features: [
      ...
      'Priority support through emails and calls',
      'Up to 5 team members',
      'Custom rules configuration for company requirements',
      'API access',
    ],
    cta: 'Start Free Trial',
    highlighted: true,
  },
  {
    ...
    features: [
      ...
      '24/7 priority support through emails and calls',
      'Unlimited team members',
      'Advanced security suite',
      'Dedicated engineering team support',
